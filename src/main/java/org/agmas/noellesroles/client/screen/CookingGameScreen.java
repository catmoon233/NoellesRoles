...
public class CookingGameScreen extends AbstractPixelScreen {
    ...
    public static class InfoCard extends AbstractWidget {
        ...
        public InfoCard(int i, int j, int k, int l, int buffID, int textureWidth, int textureHeight, ResourceLocation texture) {
        ...
        public static final Pair<Color, Color> PROCESS_BAR_COLOR =
                new Pair<>(new Color(0xFF000000, true), new Color(0xFF77CCFF, true));
    ...
    protected void init() {
        ...
        tickTimers.add(new TickTimerWidget(
                ...
                (TickTimerWidget) -> {
                    ...
                    startStringWidget.setPosition(originalX, (int) (centerY / START_STRING_SCALE - (float) strWidgetSize / 2));
                    // 停止倒计时
                    ...
                    buffTimers.add(new TickTimerWidget(
                        10,
                            ...
                            (timerWidget) -> {
                                ...
                                scoreBarWidth = INFO_BOUND * 2 + (scoreCardSize + INFO_INTERVAL) * ROW_BUFF_NUM - INFO_INTERVAL;
                                maxScoreBarHeight =
                                        INFO_BOUND * 2 + (scoreCardSize + textHeight + INFO_INTERVAL) * rowNum - INFO_INTERVAL;
                                int aniTick = 10;
    ...
    public void tick() {
        ...
        if (foods.size() < MAX_FOOD_COUNT && nextTick <= 0) {
            ...
            int scale = (int) ((foodScaleBounds.second - foodScaleBounds.first) * buffTimePercentage + foodScaleBounds.first);
                ...
                if (GameItem.isOverlap(food, pan) && food.imgWidget.getBottom() >= pan.imgWidget.getBottom()) {
                    ...
                    if (!infoCards.containsKey(food.buffID)) {
                        ...
                        animations.add(BezierAnimation.builder(
                            ...
                            new Vec2(0,
                            INFO_BOUND + (BASE_FOOD_SIZE * pixelSize + INFO_INTERVAL) * (infoCards.size() - 1) - height
                            ),
    ...
    private static final Pair<Color, Color> INFO_BG_COLOR =
            new Pair<>(new Color(0x4F555555, true), new Color(0xFF77CCFF, true));
    /** 游戏部分屏幕占比(x) */
    ...
    private final Pair<Integer, Integer> foodScaleBounds = new Pair<>(FOOD_SCALE_BOUNDS.first, FOOD_SCALE_BOUNDS.second);
