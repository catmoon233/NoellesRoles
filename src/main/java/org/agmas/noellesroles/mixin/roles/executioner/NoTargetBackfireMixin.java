...
public class NoTargetBackfireMixin {
    @WrapOperation(method = "receive", at = @At(value = "INVOKE", target = "Ldev/doctor4t/trainmurdermystery/cca/GameWorldComponent;isInnocent(Lnet/minecraft/world/entity/player/Player;)Z", ordinal = 0))
