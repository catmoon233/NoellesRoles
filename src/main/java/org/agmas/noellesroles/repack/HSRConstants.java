...
public class HSRConstants {
    ...
    static {
        ...
        // 毒药瓶/75
        POISONER_SHOP_ENTRIES.add(new ShopEntry(TMMItems.POISON_VIAL.getDefaultInstance(), 75, ShopEntry.Type.POISON));
        // 毒蝎子/50
        POISONER_SHOP_ENTRIES.add(new ShopEntry(TMMItems.SCORPION.getDefaultInstance(), 50, ShopEntry.Type.POISON));
        // 爆竹/10
        ...
        BANDIT_SHOP_ENTRIES.add(new ShopEntry(HSRItems.BANDIT_REVOLVER.getDefaultInstance(), 175, ShopEntry.Type.WEAPON));
